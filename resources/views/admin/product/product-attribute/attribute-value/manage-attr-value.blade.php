        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">Danh sách ( Tổng: {{$count_attr_value}} phân loại )</h4>
                    </div>
                    <a href="{{URL::to('/add-attr-value')}}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Thêm</a>
                </div>
            </div>
