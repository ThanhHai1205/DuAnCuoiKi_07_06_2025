            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="product-item">
                        ...
                        <td class="remove">
                            <a class="view-hover delete-pd-cart" href="{{ url('/delete-pd-cart/' . $pd_cart->idCart) }}">
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <p class="price" style="color: red; float: right;">{{number_format($Total,0,',','.')}}đ</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
