        ...
        <div class="row flex-row-reverse">
                ...
                <div class="shop-top-bar d-sm-flex align-items-center justify-content-between mt-3">
                    ...
                    <div class="top-bar-sorter">
                        <div class="sorter-wrapper d-flex align-items-center">
                            <label style="color: #f379a7;">Sắp xếp theo:</label>
                    ...
                    <div class="top-bar-page-amount">
                        <p><span style="color: #f379a7;">Có:</span> {{$count_pd}} sản phẩm</p>
                    </div>
                </div>
                <!--Shop Top Bar End-->
            ...
            <div class="col-lg-3">
                <div class="shop-sidebar">
                    ...
                    <h4 style="color: #f379a7;"><i class="fa fa-filter"></i> BỘ LỌC TÌM KIẾM</h4>
