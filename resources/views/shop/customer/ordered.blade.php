                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%;">
                                    ...
                                    <tbody>             
                                        ...
                                        <tr>
                                            ...
                                            @if($bill->Status == 0) <td style="color: red;">Chờ xác nhận</td>
                                            @elseif($bill->Status == 1) <td style="color: blue;">Đang giao hàng</td>
                                            @elseif($bill->Status == 2) <td style="color: green;">Đã hoàn tất</td>
                                            @else <td style="color: gray;">Đã hủy</td> @endif

                                            <td style="color: red;">{{number_format($bill->TotalBill,0,',','.')}}đ</td>
